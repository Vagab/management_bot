defmodule FinanceChatIntegrationWeb.Router do
  ...
  import FinanceChatIntegrationWeb.UserAuth
  ...
  scope "/", FinanceChatIntegrationWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{FinanceChatIntegrationWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", FinanceChatIntegrationWeb do
    ...
    live_session :current_user,
      on_mount: [{FinanceChatIntegrationWeb.UserAuth, :mount_current_user}] do
